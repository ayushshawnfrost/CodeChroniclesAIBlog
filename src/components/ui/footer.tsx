        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {/* <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12"> */}
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">This website is purely for learning purposes. Feel free to play around and experiment. by &copy; Cruip.com. All rights reserved.</div>
              <div className="text-gray-400 flex text-sm mr-4 justify-center items-center "></div>
            </div>
          ...
          {/* <div className="md:flex md:items-center md:justify-between"> */}
            ...
            {/* Copyrights note */}
            {/* <div className="text-gray-400 text-sm mr-4">by &copy; Cruip.com. All rights reserved.</div> */}
